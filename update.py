...
try:
    ...
    UPSTREAM_REPO = "https://github.com/estudosallshare/knuckles137"
try:
...
update = srun([f"git init -q \
                 && git config --global user.email estudos.allshare@gmail.com \
                 && git config --global user.name estudosallshare \
                 && git add . \
